...
const ItemSelectTrack = (props: any) => {
    ...
    return (
            <ItemSelect name={"Tracks"} id={props.value} value={trackCodeToName(props.value)} values={props.tracks} onChange={props.onChange} />
    )
}
...
const ItemSelect = (props: any) => {
    ...
    return (
        <div>
            ...
            {
                activeSelection &&
                <div className="absolute w-full h-full overflow-hidden top-0 left-0 bg-[rgba(28,28,30,.5)] backdrop-blur">
